...
const questions = [
  ...
  {
    question: "Какое общение с клиентами вам комфортно? (Вопрос 8/30)",
    options: [
      "Минимальное, люблю тишину",
      "Иногда, если нужно",
      "Постоянное, люблю общаться",
  ...
  {
    question: "Как вы относитесь к поставленному времени на выполение задач? (Вопрос 16/30)",
    options: [
  ...
  {
    question: "Что вам проще? (Вопрос 22/30)",
    options: [
      "Придумать идею",
      "Реализовать план",
